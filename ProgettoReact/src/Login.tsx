...
const Header: React.FunctionComponent = () => {
    ...
    return <>
           <div>
                 ...
                 <div className="my-3 p-1 w-25 mx-auto"> <input type="checkbox"/> Hai scordato la password? </div>
                 <div className=""> <div className="my-3 text-center col-6 mx-auto"> <button type="submit"> Submit </button>
                       <div className="d-inline text-center col-6 mx-auto"> <button type="button"> Register </button></div> </div>
                 </div>
           </div>
